      ...
      <div className="border-l-6 border-l-black border-opacity-30 pl-4">
        ...
        <div className="mt-14 w-full border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            subTitle="Bishop's College"
            result="Commerce Stream"
            des="Completed General Certificate of Education Advanced Level (GCE A-levels) with a focus on Commerce, supplemented with proficiency in Information Technology."
          />
        </div>
      </div>
    </motion.div>
