    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-14">
        ...
        <ProjectsCard
          ...
          des=" A comprehensive e-commerce platform offering a diverse range of products, providing users with a secure and user-friendly online shopping experience."
          src={projectOne}
        />
        <ProjectsCard
          title="Chatting App"
